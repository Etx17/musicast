class RequirementItem < ApplicationRecord
  ...
  enum :type_item, { youtube_link: 0, recommendation_letter: 1, parental_authorization: 2, motivation_essay: 3, photo: 4 }
  ...
  def is_photo?
    RequirementItem.photo_items.include?(self.type_item)
  end
end
