module InscriptionsHelper
  def buttons_for_inscription(inscription)
    buttons = []
    view_button = link_to 'Voir', organism_competition_edition_competition_category_inscription_path(inscription.organism, inscription.competition, inscription.edition_competition, inscription.category, inscription), class: 'btn btn-primary', target: '_blank'
    buttons << view_button
