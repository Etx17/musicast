...
class PrizesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prize" do
    assert_difference("Prize.count") do
      post prizes_url, params: { prize: { amount: @prize.amount, category_id: @prize.category_id, description: @prize.description, title: @prize.title } }
    end
  ...
  test "should update prize" do
    patch prize_url(@prize), params: { prize: { amount: @prize.amount, category_id: @prize.category_id, description: @prize.description, title: @prize.title } }
